...
function getColorFromValue(value: [number, number, number, number] | number): [number, number, number, number] {
...
function drawTextLabel(label: string, position:[number, number], options:{[param: string]:any}) {
