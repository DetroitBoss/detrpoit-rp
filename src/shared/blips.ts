...
export const BUSINESS_BLIPS: {type: BUSINESS_TYPE, subtype: number, blip: number, color: number, scale?: number}[] = [
    {type: BUSINESS_TYPE.BANK, subtype: 0, blip: 108, color: 60},
    {type: BUSINESS_TYPE.BANK, subtype: 1, blip: 108, color: 69},
    {type: BUSINESS_TYPE.BANK, subtype: 2, blip: 108, color: 69},
    {type: BUSINESS_TYPE.BANK, subtype: 3, blip: 108, color: 69},
    ...
    {type: BUSINESS_TYPE.VEHICLE_SHOP, subtype: 0, blip: 811, color: 11, scale: 0.7},
    {type: BUSINESS_TYPE.VEHICLE_SHOP, subtype: 1, blip: 810, color: 4},
    {type: BUSINESS_TYPE.VEHICLE_SHOP, subtype: 2, blip: 810, color: 4},
    {type: BUSINESS_TYPE.VEHICLE_SHOP, subtype: 3, blip: 823, color: 4},
    {type: BUSINESS_TYPE.VEHICLE_SHOP, subtype: 4, blip: 226, color: 4},
    {type: BUSINESS_TYPE.VEHICLE_SHOP, subtype: 5, blip: 404, color: 4},
    {type: BUSINESS_TYPE.VEHICLE_SHOP, subtype: 6, blip: 759, color: 4},
    {type: BUSINESS_TYPE.VEHICLE_SHOP, subtype: 7, blip: 810, color: 4},
    {type: BUSINESS_TYPE.VEHICLE_SHOP, subtype: 8, blip: 799, color: 60},
