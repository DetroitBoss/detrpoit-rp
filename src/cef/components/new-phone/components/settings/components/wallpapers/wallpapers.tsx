...
export class Wallpapers extends Component<
  { onBgChange: any, bg: string, onBack: any; setSettings: (params: Partial<PhoneSettings>) => void },
  {
    selectedBg: string;
    bgList: string[];
  }
> {
  ...
  render() {    return (
      <div className="np-settings-wallpapers">
        <div className="np-settings-back-btn" onClick={() => this.props.onBack()}>
          <svg
            width="16"
            height="16"
            viewBox="0 0 16 16"
        ...
        <div className="np-settings-sub-title">Обои</div>
